      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <select
            ...
            className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-slate-500 bg-white"
          >
        ...
        <div className="bg-slate-50 rounded-lg border border-slate-100 p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <Link to="/help" className="text-slate-600 hover:underline">
                  Browse articles
                </Link>
              </div>
            </div>
