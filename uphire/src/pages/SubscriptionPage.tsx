                ...
                <div className="space-y-1.5">
                  <div>
                    <span className="text-base font-semibold text-cyan-400">
                      {plan.tiers[0].months}-month term £
                      {plan.tiers[0].price.toLocaleString()}
                      {plan.tiers[0].perMonth && " /month"}
                    </span>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-pink-400">
                      {plan.tiers[1].months}-month term £
                      {plan.tiers[1].price.toLocaleString()}
                    </span>
                  ...
                  <div>
                    <span className="text-sm font-medium text-purple-400">
                      {plan.tiers[2].months}-month term £
                      {plan.tiers[2].price.toLocaleString()}
                    </span>
